...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: seo.metaDescription || "Our privacy policy and data protection information",
    ...
    openGraph: {
      ...
      description: seo.openGraphDescription || seo.metaDescription || "Our privacy policy and data protection information",
      url: seo.canonicalUrl || `${process.env.NEXT_PUBLIC_SITE_URL}/privacy-policy`,
      siteName: "Inexor",
      type: "website",
