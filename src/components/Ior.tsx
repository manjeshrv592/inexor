...
const Ior = () => {
  return (
    <div className="absolute size-full">
      <div className="absolute z-10 size-full bg-[linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.8)),url('/img/services/services-4.jpg')] bg-cover bg-center grayscale filter"></div>
      <div className="relative z-20 size-full p-8">
        ...
        <p className="mx-auto max-w-[600px] bg-neutral-700/30 p-6 text-center text-sm backdrop-blur-sm">
